...
| `VXP-Core-Library-v0.8.2/` | `0.8.2` | `dist/vxp-core-0.8.2.jar` | 최신: Thumb ALU, SMS 샌드박스, 장기 회귀 |

신규 연동은 **v0.8.2** 사용. 자세한 내용은 `VERSIONS.md`.

## 3. 백엔드

- `ELF32 ARM` → Kotlin ARM/Thumb + MRE: 지원.
...
미리 빌드된 `dist/vxp-core-0.8.2.jar` 사용도 가능합니다.
