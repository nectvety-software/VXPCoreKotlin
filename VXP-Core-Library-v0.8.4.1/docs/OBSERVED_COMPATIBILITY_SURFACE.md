...
VXP-Core v0.8.4.1 does not build an API catalog from proprietary vendor headers. Compatibility expansion follows a binary-observation workflow:
...
The v0.8.4.1 corpus closes several naming differences seen across toolchains, including screen width/height aliases, callback aliases, image buffer/property aliases, resource init/load aliases and file-size variants.
