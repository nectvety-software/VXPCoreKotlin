                ...
                when (event) {
                    ...
                    is MreEvent.GuestCallback -> {
                        if (event.callback != 0) {
                            ...
                            cpu.callGuest(event.callback, event.args, maxInstructionsPerCallback)
                            eventsDispatched++
                        }
                    }
                }
