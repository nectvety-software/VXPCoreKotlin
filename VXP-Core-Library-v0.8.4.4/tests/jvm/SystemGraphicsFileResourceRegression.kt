...
fun main() {
    val root = File("/mnt/data/VXP-Core-Library-v0.8.4.3/build/runtime_regression_fs").apply { deleteRecursively(); mkdirs() }
    ...
    rt.close()
    println("[OK] v0.8.4.3 FILE_RESOURCE regression passed")
}
